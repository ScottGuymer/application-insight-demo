...
local params = std.extVar("__ksonnet/params").components.dotnetcore;
...
local envFrom = k.apps.v1beta1.deployment.mixin.spec.template.spec.containersType.envFromType;
